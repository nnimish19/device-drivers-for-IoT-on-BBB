...
int adc_channel;		// select the pin to which the sensor is connected
...
void StepConfig(struct adc_csreg *pReg)
{
	...
	ADCStepConfig(pReg, 0, adc_channel, ADC_POSITIVE_REF_VDDA, adc_channel, ADC_NEGATIVE_REF_VSSA);
